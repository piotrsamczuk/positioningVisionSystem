...
private:
    ...
    void drawAxis(cv::Mat& matImg, cv::Mat K, cv::Mat D, cv::Mat rvec, cv::Mat tvec, float checkersize);
...
void Calibrator::drawAxis(cv::Mat& matImg, cv::Mat K, cv::Mat D, cv::Mat rvec, cv::Mat tvec, float checkersize)
{
